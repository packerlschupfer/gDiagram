...
class PreviewPanel {
    static createOrShow(extensionUri, document, client) {
        ...
        const panel = vscode.window.createWebviewPanel(PreviewPanel.viewType, `Preview: ${getFileName(document.fileName)}`, vscode.ViewColumn.Beside, {
            enableScripts: true,
...
PreviewPanel.viewType = 'gdiagram.preview';
PreviewPanel.panels = new Map();
PreviewPanel.renderTimers = new Map();
