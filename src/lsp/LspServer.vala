    ...
    public class LspServer : Object {
        ...
        private void handle_export_file(Json.Node? id, Json.Node? params_node) {
            ...
            switch (export_format) {
                case "png":
                    success = engine.export_to_png(state.content, null, state.file_path, output_path);
                    break;
                case "pdf":
                    success = engine.export_to_pdf(state.content, null, state.file_path, output_path);
                    break;
                default:
                    success = engine.export_to_svg(state.content, null, state.file_path, output_path);
                    break;
            }
