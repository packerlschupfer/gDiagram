...
public class YamlDiagram : Object {
    ...
    // "skinparam name value" lines (a <style> block arrives as those), keys lowercased
    public Gee.HashMap<string, string> skin { get; private set; }
    public Gee.ArrayList<ParseError> errors { get; private set; }

    public YamlDiagram() {
        this.diagram_type = DiagramType.YAML_DIAGRAM;
        this.highlights = new Gee.ArrayList<string>();
        this.skin = new Gee.HashMap<string, string>();
