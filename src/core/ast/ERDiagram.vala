namespace GDiagram {
    ...
    public class EREntity : Object {
        ...
        // "entity A <<foo>>": shown above the name, and selects "<style> .foo { }" rules
        ...
        public string get_dot_id() {
            if (alias != null && alias.length > 0) {
                // Guards DOT keywords: an alias "node" would be a default-attribute statement
                return RenderUtils.sanitize_id(alias);
            }
