namespace GDiagram {
    ...
    public class State : Object {
        ...
        // "#pink;line:red;line.dashed;text:blue": border colour, border style
        // ("dashed" / "dotted" / "bold") and text colour
        public string? line_color { get; set; default = null; }
        public string? line_style { get; set; default = null; }
        public string? text_color { get; set; default = null; }
        public int source_line { get; set; }
        // Concurrent region of the enclosing composite this state was first placed in
        // (0, 1, ... separated by "--" or "||" lines in the body)
        public int region { get; set; default = 0; }
        // For a composite with concurrent regions: "--" (stacked) or "||" (side by side)
        public string? region_separator { get; set; default = null; }
    ...
    public class StateTransition : Object {
        ...
        // From the arrow: "-[dotted]->" / "-[bold]->" / "-[hidden]->" ("dotted", "bold",
        // "invis"), and a direction word "-up->" (up / down / left / right, or "")
        public string? line_style { get; set; default = null; }
        public string direction { get; set; default = ""; }
        // Number of line characters in the arrow: 1 for "->" (drawn side by side, as in
        // PlantUML), 2 for "-->", 3 for "--->" (a longer link)
        public int arrow_length { get; set; default = 2; }
    ...
    public class StateNote : Object {
        ...
        // "note on link": the transition written just before the note
        public StateTransition? link { get; set; default = null; }
