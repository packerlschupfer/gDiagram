        ...
        public ActivityNode parse_action(string? color, string? color2,
            ...
            while (!check(TokenType.SEMICOLON) && !is_at_end()) {
                ...
                if (t.token_type == TokenType.NEWLINE) {
                    ...
                    // Check for Creole formatting markers
                    // Only skip space when forming double markers (**,  //, etc.)
                    bool prev_is_same_creole = (t.lexeme == "*" && sb.str.has_suffix("*")) ||
                                                (t.lexeme == "/" && sb.str.has_suffix("/")) ||
                                                (t.lexeme == "_" && sb.str.has_suffix("_")) ||
                                                (t.lexeme == "~" && sb.str.has_suffix("~"));
                    ...
                    // Skip only when forming double markers (**, //) not before/after them
