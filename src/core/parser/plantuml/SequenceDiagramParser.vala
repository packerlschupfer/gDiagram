namespace GDiagram {
    public class Parser : Object {
        ...
        private void parse_statement() throws Error {
            ...
            // Skinparam (consume keyword + rest of line)
            ...
            if (check(TokenType.SEPARATOR)) {
                advance();
                // Consume title text between separators
                consume_rest_of_line();
            ...
            // Scale, Caption, Hide, Show (consume keyword + rest of line)
            if (check(TokenType.SCALE) || check(TokenType.CAPTION) ||
