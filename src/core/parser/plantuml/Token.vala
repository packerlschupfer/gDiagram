namespace GDiagram {
    ...
    public class Token : Object {
        ...
        // Whitespace preceded this token in the source. Parsers that rebuild
        // label text from tokens use it to put spaces back only where the author
        // wrote them; joining every token with " " turned ">=" into "> =",
        // "°C" into "° C" and "Result<void>" into "Result < void >".
        public bool space_before;
