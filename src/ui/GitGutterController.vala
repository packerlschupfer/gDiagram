namespace GDiagram {
    ...
    public class GitGutterController : Object {
        ...
        private static void on_blame_popover_closed(Gtk.Popover popover) {
        ...
        private void show_blame_popover(GitBlameEntry entry, Gdk.Rectangle cell_area) {
            ...
            // No closure over `popover`: it would keep the popover (and this controller) alive
            popover.closed.connect(on_blame_popover_closed);
