...
# Resolution of the virtual display: the app opens at 1200x800 and Xvfb has no
# window manager to maximize it, so a larger screen left a black border around
# the window in every capture.
RES="1200x800x24"
#
# The committed docs/images/app/*.png were taken maximized at 1600x968 in a
# headless GNOME session (sidebars, palette and properties panel opened by hand,
# editor/preview divider moved, zoom-to-fit with Ctrl+9); this script is the
# quick, unattended fallback.
